function generateGigsFromData(gigID, gigObject) {
    ...
    var dropdownButton = '<button id="DDB' + gigID + '" class="mdl-button mdl-js-button mdl-button--icon dropdown-button btn-info-edit"><i class="material-icons">more_vert</i></button>';
