function createPortfolio(data) {
    ...
    imageDiv = '<div class="image"><img src="/api/v1/my/img/?q='+$data.imageHash+'" alt="Logo Image"></div>';
    ...
    var descriptionDiv = '<div class="main-description col-lg-8 col-md-7 col-sm-8 col-xs-12">' + dropdownButton + dropdownUL + '<p class="description">' + $data.heading + '<br /><br /><br />' + $data.description + '</p></div>';
