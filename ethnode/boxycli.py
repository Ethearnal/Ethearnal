...
import getopt
import os
from boxy.relay import udp
from boxy.relay import tcp
from boxy.relay import status
...
print("Relay starting on port {0}, relaying {1} to {2}:{3}".format(
    relayport, protocol, remoteaddress, remoteport))
